...
public class MainView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public MainView (Context context) {
        ...
        Assets.sound_squish1 = Assets.soundPool.load(context, R.raw.squish, 1);
        ...
        Assets.sound_highscore = Assets.soundPool.load(context,R.raw.newhighscore,1);
        Assets.sound_ladybug = Assets.soundPool.load(context,R.raw.ladybugdeath,1);
        Assets.sound_superbug = Assets.soundPool.load(context,R.raw.superbugkill,1);

        Assets.score = 0;
        Assets.mp= MediaPlayer.create(context, R.raw.gamemusic);
